...
for product in products:
    try:
        ...
        products_list = [product_url, product_name, product_price] #array of products and their descriptions

        #Open and update google sheets
        ...
        worksheet = worksheet.insert_rows(1, values= products_list)  #Insert all values to worksheet
    except:
        pass